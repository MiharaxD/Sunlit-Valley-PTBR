...
Pronto. As quests devem aparecer traduzidas.

## Recomendação

Faça um backup da pasta do modpack antes de instalar, principalmente se você já tiver feito outras modificações.
